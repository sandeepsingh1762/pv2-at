...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object v1, p0, Landroidx/appcompat/widget/ActionBarContextView;->e:Li/a;
    ...
    iput-object v2, p0, Landroidx/appcompat/widget/ActionBarContextView;->f:Landroid/content/Context;

    goto :goto_0

    :cond_0
    iput-object p1, p0, Landroidx/appcompat/widget/ActionBarContextView;->f:Landroid/content/Context;
    ...
    invoke-static {p0, p1}, Lu0/y;->q(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V
...
.method public final c(Lg/b;)V
    ...
    invoke-virtual {p1}, Lg/b;->e()Lh/o;

    move-result-object p1

    iget-object v0, p0, Landroidx/appcompat/widget/ActionBarContextView;->h:Li/m;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/ActionBarContextView;->h:Li/m;

    const/4 v2, 0x1

    iput-boolean v2, v0, Li/m;->p:Z

    iput-boolean v2, v0, Li/m;->q:Z
    ...
    iget-object v2, p0, Landroidx/appcompat/widget/ActionBarContextView;->h:Li/m;

    iget-object v3, p0, Landroidx/appcompat/widget/ActionBarContextView;->f:Landroid/content/Context;

    invoke-virtual {p1, v2, v3}, Lh/o;->b(Lh/c0;Landroid/content/Context;)V

    iget-object p1, p0, Landroidx/appcompat/widget/ActionBarContextView;->h:Li/m;

    iget-object v2, p1, Li/m;->l:Lh/e0;

    if-nez v2, :cond_3

    iget-object v3, p1, Li/m;->h:Landroid/view/LayoutInflater;
    ...
    iput-object v1, p1, Li/m;->l:Lh/e0;

    iget-object v3, p1, Li/m;->g:Lh/o;

    invoke-interface {v1, v3}, Lh/e0;->a(Lh/o;)V

    invoke-virtual {p1}, Li/m;->h()V

    :cond_3
    iget-object v1, p1, Li/m;->l:Lh/e0;
    ...
    iput-object v1, p0, Landroidx/appcompat/widget/ActionBarContextView;->g:Landroidx/appcompat/widget/ActionMenuView;

    sget-object p1, Lu0/n0;->a:Ljava/util/WeakHashMap;

    const/4 p1, 0x0

    invoke-static {v1, p1}, Lu0/y;->q(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V

    iget-object p1, p0, Landroidx/appcompat/widget/ActionBarContextView;->g:Landroidx/appcompat/widget/ActionMenuView;
...
.method public final e()V
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/ActionBarContextView;->g:Landroidx/appcompat/widget/ActionMenuView;
...
.method public final g(Landroid/content/res/Configuration;)V
    ...
    iget-object v0, p1, Li/m;->f:Landroid/content/Context;
...
.method public getAnimatedVisibility()I
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/ActionBarContextView;->j:Lu0/u0;

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroidx/appcompat/widget/ActionBarContextView;->e:Li/a;
...
.method public getContentHeight()I
    ...
    iget v0, p0, Landroidx/appcompat/widget/ActionBarContextView;->i:I
...
.method public final l(IJ)Lu0/u0;
    .locals 3
    ...
    :cond_1
    invoke-static {p0}, Lu0/n0;->a(Landroid/view/View;)Lu0/u0;
    ...
    invoke-virtual {v1, p2, p3}, Lu0/u0;->c(J)V

    iget-object p2, v0, Li/a;->c:Landroidx/appcompat/widget/ActionBarContextView;

    iput-object v1, p2, Landroidx/appcompat/widget/ActionBarContextView;->j:Lu0/u0;

    iput p1, v0, Li/a;->b:I

    invoke-virtual {v1, v0}, Lu0/u0;->d(Lu0/v0;)V
    ...
    invoke-virtual {v2, v1}, Lu0/u0;->a(F)V

    invoke-virtual {v2, p2, p3}, Lu0/u0;->c(J)V

    iget-object p2, v0, Li/a;->c:Landroidx/appcompat/widget/ActionBarContextView;

    iput-object v2, p2, Landroidx/appcompat/widget/ActionBarContextView;->j:Lu0/u0;

    iput p1, v0, Li/a;->b:I

    invoke-virtual {v2, v0}, Lu0/u0;->d(Lu0/v0;)V
...
.method public final onLayout(ZIIII)V
    ...
    :cond_5
    :goto_5
    iget-object p3, p0, Landroidx/appcompat/widget/ActionBarContextView;->r:Landroid/widget/LinearLayout;

    if-eqz p3, :cond_6

    iget-object v3, p0, Landroidx/appcompat/widget/ActionBarContextView;->q:Landroid/view/View;
    ...
    :goto_6
    iget-object p3, p0, Landroidx/appcompat/widget/ActionBarContextView;->g:Landroidx/appcompat/widget/ActionMenuView;
...
.method public final onMeasure(II)V
    ...
    :cond_1
    iget-object v6, p0, Landroidx/appcompat/widget/ActionBarContextView;->g:Landroidx/appcompat/widget/ActionMenuView;
    ...
    :cond_c
    iget p2, p0, Landroidx/appcompat/widget/ActionBarContextView;->i:I
...
.method public setTitle(Ljava/lang/CharSequence;)V
    ...
    invoke-static {p0, p1}, Lu0/n0;->i(Landroid/view/View;Ljava/lang/CharSequence;)V
