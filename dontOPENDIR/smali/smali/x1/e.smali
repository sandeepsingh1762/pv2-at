...
.method public a(ILandroid/content/Context;Ljava/lang/String;)Landroid/content/Intent;
    ...
    invoke-static {p2}, Ls1/o0;->n(Landroid/content/Context;)Z
    ...
    :try_start_0
    invoke-static {p2}, Lf2/b;->a(Landroid/content/Context;)Landroidx/emoji2/text/p;
    ...
    iget-object p3, p3, Landroidx/emoji2/text/p;->a:Landroid/content/Context;
...
.method public b(Landroid/content/Context;I)I
    ...
    sget-object v0, Lx1/g;->b:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    :cond_0
    sget-object v0, La2/u;->a:Ljava/lang/Object;

    monitor-enter v0

    :try_start_1
    sget-boolean v2, La2/u;->b:Z
    ...
    :cond_5
    :goto_4
    invoke-static {p1}, Ls1/o0;->n(Landroid/content/Context;)Z
    ...
    sget-object v0, Ls1/o0;->e:Ljava/lang/Boolean;
    ...
    sput-object v0, Ls1/o0;->e:Ljava/lang/Boolean;
    ...
    const-class v8, Lx1/h;

    monitor-enter v8

    :try_start_9
    sget-object v9, Lx1/h;->e:Lx1/h;

    if-nez v9, :cond_c

    sget-object v9, Lx1/p;->a:Lx1/k;
    ...
    invoke-direct {v9, p1, v2}, Lx1/h;-><init>(Landroid/content/Context;I)V

    sput-object v9, Lx1/h;->e:Lx1/h;
    ...
    invoke-static {v7}, Lx1/h;->b(Landroid/content/pm/PackageInfo;)Z
    ...
    invoke-static {v6}, Ls1/o0;->c(Ljava/lang/Object;)V

    invoke-static {v6}, Lx1/h;->b(Landroid/content/pm/PackageInfo;)Z
    ...
    invoke-static {p1}, Lx1/g;->a(Landroid/content/Context;)Z
